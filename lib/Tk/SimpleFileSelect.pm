...
sub Populate {
    ...
    #my $lb = $w->Component( ScrlListbox    => 'dir_list', -scrollbars => 'se', -width => \$w -> {Configure}{-width}, -height => \$w -> {Configure}{-height} );
    my $lb = $w->Component( ScrlListbox    => 'dir_list', -scrollbars => 'se', -width => $w->{Configure}{-width} || 30, -height => $w->{Configure}{-height} || 14 );
    #my $lb = $w->Component( ScrlListbox    => 'dir_list', -scrollbars => 'se', -width => 30, -height => 14 );
